...
from ortho.util import normalize_columns
...
def cosine_similarity_matrix(matrix):
    ...
    :return: A matrix describing column-wise orthogonality of the input matrix.
...
def total_cosine_simiarity(matrix):
    """
    :param matrix: Any square NxN matrix.
    :return: A scalar describing column-wise orthogonality of the input matrix.
...
def mean_cosine_similarity(matrix):
    """
    :param matrix: Any square NxN matrix
    :return: Same as total_cosine similarity, but normalized by the number of
